...
class Chatbot extends Component {
    ...
    _handleQuickReplyPayload(event, payload, text) {
        // to prevent the default link behaviour, i.e. opening the link in href => onClick will happen right after the page itself will reload.
        event.preventDefault();
        event.stopPropagation();
